        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div>
            <h2 className="font-heading text-foreground leading-none mb-4" style={{ fontSize: "clamp(2.5rem, 8vw, 4.5rem)" }}>
              SEE US IN<br /><span className="text-primary">ACTION.</span>
            </h2>
            <p className="font-sans text-muted-foreground text-base leading-relaxed max-w-sm mb-6">
          ...
          <div className="overflow-hidden bg-black" style={{ aspectRatio: "1 / 1" }}>
            <video
              src={REEL2_URL}
              autoPlay
              muted
