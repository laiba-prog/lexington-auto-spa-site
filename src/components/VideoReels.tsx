        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://www.instagram.com/lexingtonautospaky/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-[hsl(var(--dark))] hover:opacity-75">
              ...
              <a href="https://www.facebook.com/lexingtonautospa/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-[hsl(var(--dark))] hover:opacity-75">
          ...
          {/* Right: video — sharp, full column width */}
          <div className="overflow-hidden bg-black rounded-3xl" style={{ aspectRatio: "1 / 1" }}>
            <video
              src={REEL2_URL}
              autoPlay
              muted
