      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          <div className="lg:col-span-1">
            ...
            <p className="text-white/60 font-display text-sm leading-relaxed">Keeping Lexington Vehicles Spotless Since 2005.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex gap-2.5"><MapPin className="w-4 h-4 text-primary flex-shrink-0 mt-0.5" /><span className="text-white/60 font-display text-sm">1124 Winchester Road, Lexington, KY 40505</span></li>
        ...
        <div className="border-t border-white/10 pt-8 text-center">
          <p className="text-white/40 font-display text-sm">© 2025 Lexington Auto Spa. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
